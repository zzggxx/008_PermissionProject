...
public abstract class CheckPermissionsActivity extends AppCompatActivity {
    ...
    protected String[] externalsdcardpermission = {
            Manifest.permission.WRITE_EXTERNAL_STORAGE,
            Manifest.permission.READ_EXTERNAL_STORAGE
    };
...
//        }
        ...
        try {
            if (Build.VERSION.SDK_INT >= 23 && getApplicationInfo().targetSdkVersion >= 23) {
                ...
                if (null != needRequestPermissonList && needRequestPermissonList.size() > 0) {
                    ...
                    Method method =
                            getClass().getMethod("requestPermissions", new Class[]{String[].class, int.class});
    ...
    protected abstract void beGivenPermission();

    protected abstract void beRefusePermission();
